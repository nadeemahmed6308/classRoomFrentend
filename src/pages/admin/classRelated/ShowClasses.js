...
//   const classRows = classesList && classesList.length > 0 && classesList.map((class) => {
//     return {
...
//     return (
//       <ButtonContainer>
//         <IconButton onClick={() => deleteHandler(row.id, "Class")} color="secondary">
...
//       action: () => deleteHandler(adminID, "Classes")
//     },
//   ];
...
const ShowClasses = () => {
  ...
  const classRows = classesList && classesList.length > 0 && classesList.map((classItem) => ({
