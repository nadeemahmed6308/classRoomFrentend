...
import { getClassStudents, getSubjectDetails } from '../../../redux/classRelated/classHandle';
...
const ViewSubject = () => {
  ...
  const { subloading, subjectDetails, classStudents, getresponse, error } = useSelector((state) => state.class);
