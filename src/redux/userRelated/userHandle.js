...
export const loginUser = (fields, role) => async (dispatch) => {
    ...
    try {
        // const result = await axios.post(`${process.env.REACT_APP_BASE_URL}/${role}Login`,
         const result = await axios.post(`/${role}Login`,
        fields, {
            headers: { 'Content-Type': 'application/json' },
        });
        if (result.data.role) {
...
export const registerUser = (fields, role) => async (dispatch) => {
    ...
    try {
        // const result = await axios.post(`${process.env.REACT_APP_BASE_URL}/${role}Reg`,
        const result = await axios.post(`/${role}Reg`, 
        fields, {
            headers: { 'Content-Type': 'application/json' },
        });
        if (result.data.schoolName) {
...
export const addStuff = (fields, address) => async (dispatch) => {
    ...
    try {
    // const result = await axios.post(`${process.env.REACT_APP_BASE_URL}/${address}Create`, 
    const result = await axios.post(`/${address}Create`,
        fields, {
            headers: { 'Content-Type': 'application/json' },
        });
